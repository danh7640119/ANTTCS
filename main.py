...
try:
    ...
    # Đọc dữ liệu quân số (Dùng cache để load nhanh)
            ...
            with st.form("form_att"):
                ...
                for n in active_names:
                    ...
                    if stt == "Vắng":
                        ...
                        v_list.append({"Tuan": selected_week, "Ngay": selected_day, "HoTen": n, "TrangThai": "Vắng", "LyDo": re, "LoaiTruc": ", ".join(lt), "NgayTao": datetime.now().strftime("%d/%m/%Y %H:%M")})
    ...
    # --- QUÂN SỐ TỔNG QUAN (Khôi phục card màu như cũ) ---
